...
class FsodRCNN(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        # print(batched_inputs[0]['support_images'].shape)
        # print(batched_inputs[0]['image'].shape)
        # print(batched_inputs[0]['instances'])

        #change class gt_instances to 0?
        ...
        #Query image through backbone
        features = self.backbone(images.tensor)
        # print(features['res4'].shape)

        # support branches
        #Create support bboxes list
        support_bboxes_ls = []
        ...
        #Support images through backbone
        ...
        for i in range(B): # batch
            ...
            begin_rel = 0
            #Find how many positive support images exist using index idx
            ...
            #Use idx to pick the positive support features from feature_pooled
            ...
            #Take mean of all support features of positive class from support_box_features
            pos_support_box_features = support_box_features[pos_begin:pos_end].mean(0, True)
            #Attention RPN using query image, pos_features(attention map), pos_support_features_pool[1,1024,1,1] and query_gt_instances
            ...
            #Detector using query_images, query_features, pos_support_box_features, pos_proposals, query_gt_instances
            ...
            #Same as positive for all other support images that are not in query images
            neg_end = pos_end
    ...
    def init_model_voc(self):
        if 1:
            ...
            print("self.support_dict: ",self.support_dict['res4_avg'].keys())
