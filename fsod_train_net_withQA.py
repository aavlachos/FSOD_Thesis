...
from meta_faster_rcnn_QA.config import get_cfg
from meta_faster_rcnn_QA.data import DatasetMapperWithSupportCOCO, DatasetMapperWithSupportVOC
from meta_faster_rcnn_QA.data.build import build_detection_train_loader, build_detection_test_loader
from meta_faster_rcnn_QA.solver import build_optimizer
from meta_faster_rcnn_QA.evaluation import COCOEvaluator, PascalVOCDetectionEvaluator
...
class Trainer(DefaultTrainer):
    ...
    def run_step(self):
        ...
        #print("New run step, Iter: ",self._trainer.iter+1)
