...
from meta_faster_rcnn_withGCN.data.dataset_mapper_pascal_voc import DatasetMapperWithSupportVOC
from meta_faster_rcnn_withGCN.data.dataset_mapper_coco import DatasetMapperWithSupportCOCO
