...
This is a copy of fsod_rcnn of metafasterrcnn with the added module ss_edge from QA that enchances class prototypes!
...
#Too much!
    ...
    def ss_edge(self, support_feature_ls, support_cls_list=[]):
        ...
        #print(self.support_dict_base['res4_avg'].keys())
